...
def test_agent(agent_config, folder="./.checkpoints", **kwargs):
    ...
    agent = AgentBuilder.build(agent_config)
    checkpoint = (
        folder + "/checkpoint-" + str(checkpoint_number) if checkpoint_number else getLastCheckpoint(folder)
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_ep", dest="max_episodes", type=int, help="max_episodes", default=12000)
    parser.add_argument("--checkpoint", dest="checkpoint", type=str, help="checkpoint", default=None)
